...
urlpatterns = [
    ...
    path('drivers/<int:pk>/edit/', views.edit_driver, name='edit_driver'),
    ...
    path('exports/workers/', views.export_workers_excel, name='export_workers_excel'),
    path('exports/attendance-report/', views.export_attendance_report_excel, name='export_attendance_report_excel'),
    path('exports/workers-delays/', views.export_workers_delays_excel, name='export_workers_delays_excel'),
    path('exports/drivers/', views.export_drivers_excel, name='export_drivers_excel'),
    path('exports/institutions/', views.export_institutions_excel, name='export_institutions_excel'),
    path('exports/fuel-transactions/', views.export_fuel_transactions_excel, name='export_fuel_transactions_excel'),
    path('exports/car-records/', views.export_car_records_excel, name='export_car_records_excel'),
    path('exports/fountain-records/', views.export_fountain_records_excel, name='export_fountain_records_excel'),
    path('exports/maintenance/', views.export_maintenance_excel, name='export_maintenance_excel'),
    path('exports/expenses/', views.export_expenses_excel, name='export_expenses_excel'),
    path('exports/vehicle-fuel/', views.export_vehicle_fuel_excel, name='export_vehicle_fuel_excel'),
    path('exports/financial-report/', views.export_financial_report_excel, name='export_financial_report_excel'),
    path('exports/comprehensive/', views.comprehensive_export_page, name='comprehensive_export_page'),
    path('exports/comprehensive/download/', views.download_comprehensive_excel, name='download_comprehensive_excel'),
